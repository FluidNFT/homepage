      ...
      <div className="section-seven">
        ...
        <div className="footer">
          <div className="overlap-group2">
            <div className="copyright-notice valign-text-middle oxanium-medium-white-18px">{copyrightNotice}</div>
            <div className="footer-nav valign-text-middle oxanium-medium-white-32px">{footerNav}</div>
          </div>
